...
diabetes_df = pd.read_csv("C:\\Users\\jayan\\Downloads\\SWAROO\\OneDrive\\Desktop\\projects\\diabetes (1).csv")
...
def app():
    ...
    img = Image.open(r"C:\Users\jayan\Downloads\SWAROO\OneDrive\Desktop\projects\img (1).jpeg")
